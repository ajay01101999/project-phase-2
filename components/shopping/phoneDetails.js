                ...
                return(
                    <div key={i}>
                        ...
                        <ul className='ul1'>
                            ...
                            <li style={{marginTop:'20px'}}><p style={{fontFamily:'arial black'}}>PRODUCT SPECIFICATION</p></li>
                            <ul>
                                <li><b>BOX CONTENT</b>  {ele.specs.boxContent}</li>
                                <li><b>SIM TYPE</b>  {ele.specs.simType}</li>
                            </ul>
                        </ul>
                    </div>
                )
